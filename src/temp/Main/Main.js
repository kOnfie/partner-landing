  ...
  return (
    <main className="Main">
      <div className="Main__popup">
        ...
        <span className="Main__popup-msg">Дякуємо, що приєднались до нас</span>
      </div>
      <div className="container mb80">
        <h2 className="Main__title">Перетворіть свій сайт на прибуткове джерело!</h2>
      ...
      <SectionTemplate
        component={
          <UserCommentCard
            ...
            comment={
              "Підключили партенрську програму з і збільшили за квартал продаж відео техніки на 48 %."
            }
            position={"Маркетолог"}
          />
        }
